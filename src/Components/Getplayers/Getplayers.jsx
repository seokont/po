...
const headCells = [
    ...
    {id: 'First Login', numeric: true, disablePadding: false, label: 'First Login'},
    {id: 'Last Login', numeric: true, disablePadding: false, label: 'Last Login'},
    {id: 'Last Reset', numeric: true, disablePadding: false, label: 'Last Reset'},
            ...
            <TableRow >
                ...
                {headCells.map((headCell) => (
                    <TableCell
                        ...
                        sortDirection={orderBy === headCell.id ? order : false} style={{fontWeight:'bold'}}
                    >
                        <TableSortLabel
        ...
        >
            {numSelected > 0 ? (
                ...
                <Typography className={classes.title} variant="h6" id="tableTitle" component="div">
                    Players <div style={{fontSize:'20px'}}>Total Rake: <span style={{fontWeight:'bold', color:'green'}}>{t()}</span></div>
                </Typography>
            )}

{/* <FreeSolo getplayers={props.getplayers}/> */}
                                ...
                                <Tooltip title="Increment">
                                    <IconButton aria-label="Increment">
                                     <span style={{marginTop: '5px'}}>
                                                <a href={`#${props.getplayersobj[0]}`} title='Increment'
                                                   style={{color: '#706468'}}>
                                                    <table>
                                                        <tr>
                                                ...
                                                <div id={props.getplayersobj[0]} className={style.modalDialog}>
                                                    <div>
                                                        <a href="#close" title="Close" onClick={() => {
                                                            setCountDel(countDel + 1)
                                                        }} className={style.close}>X</a>
                                                        <h5>Increment For {props.getplayersobj[0]}</h5>
                                                        <BalanceIncContainer getplayersobj={props.getplayersobj}/>
                                                    </div>
                                                </div>
                                            </span>
                                    </IconButton>
                            ...
                            <td>
                                <Tooltip title="Decrement">
                                    <IconButton aria-label="Decrement">
                                     <span style={{marginTop: '5px'}}>
                                                <a href={`#${props.getplayersobj[0]}2`} title='Decrement'
                                                   style={{color: '#706468'}}>
                                                    <table>
                                                        <tr>
                                                            <td><MonetizationOnIcon/></td>
                                                ...
                                                <div id={`${props.getplayersobj[0]}2`} className={style.modalDialog}>
                                                    <div>
                                                        <a href="#close" title="Close" onClick={() => {
                                                            setCountDel(countDel + 1)
                                                        }} className={style.close}>X</a>
                                                        <h5>Increment For {props.getplayersobj[0]}</h5>
                                                        <BalanceDecContainer getplayersobj={props.getplayersobj}/>
                                                    </div>
                                                </div>
                                            </span>
                                    </IconButton>
...
export default function Getplayers(props) {
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, props.getplayers.length - page * rowsPerPage);
    ...
    return (
        <div className={classes.root}>
            ...
            {props.resultgetplayers === "" ? <div style={{textAlign: 'center'}}><CircularProgress/></div> :
                                    ...
                                    .map((row, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="right" style={{fontWeight:'bold'}}>{row.PRake}</TableCell>
                                                ...
                                                <TableCell
                                                    align="right">{row.ChipsTransfer}/{row.ChipsAccept}  </TableCell>
