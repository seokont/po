...
let p=[]; 
 ...
 p.push(n.Balance);
    ...
    return(
        ...
        <Field  component={"select"} style={{backgroundColor:'#fff', width:'360px', padding:'15px', border:'none'}} name={'user'}>        
{props.getplayers.map(n=><option value={n.Player}>{n.Player}</option>)}          
        </Field>
...
const BalanceTransferContainer = (props) => {
...
values.user,
       ...
       props.authTransferBalanceThunk(args);
    ...
    return <div>
        ...
        <BalanceTrans {...props} onSubmit={onSubmit}/>
    </div>
}
...
let BalanceTransferContainerContainer = compose(connect(mapStateToProps, {
