    ...
    return (
        ...
        <form onSubmit={props.handleSubmit}>
            <table className={style.table}>
                ...
                <tr>
                    <td>Name:</td>
                    <td><Field type="text" name={"GameID"} placeholder="fdfdfd" component={"input"}
                               title="Specify a unique table name, up to 40 characters."/></td>
                </tr>
                {/*<tr>*/}
                {/*    <td>Description:</td>*/}
                {/*    <td><Field type="text" name="Description" value=""*/}
                ...
                {/*<tr>*/}
                {/*    <td>Mixed:</td>*/}
                {/*    <td><Field type="text" name="MixedList" value=""*/}
                ...
                {/*    <td><Field type="text" name="PermPlay" value=""*/}
                ...
                {/*    <td><Field type="text" name="PermObserve" value=""*/}
                ...
                {/*    <td><Field type="text" name="PermPlayerChat" value=""*/}
                ...
                {/*    <td><Field type="text" name="PermObserverChat" value=""*/}
                ...
                {/*    <td><select name="SuspendChatAllIn"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Seats:</td>*/}
                {/*    <td><Field type="text" name="Seats" placeholder="9"*/}
                {/*               title="Select the number of seats available at this table, from 2 to 10 (8 max for Stud or Razz)."/>*/}
                {/*    </td>*/}
                {/*</tr>*/}
                {/*<tr>*/}
                {/*    <td>Start minimum:</td>*/}
                {/*    <td><Field type="text" name="StartMin" value="2"*/}
                {/*               title="Select the minimum number of ready players needed to start a new session."/></td>*/}
                {/*</tr>*/}
                {/*<tr>*/}
                {/*    <td>Start code:</td>*/}
                {/*    <td><Field type="text" name="StartCode" value="0"*/}
                ...
                {/*    <td><select name="PrimaryCurrency"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Rake cap:</td>*/}
                {/*    <td><Field type="text" name="RakeCap" value="0"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Time bank:</td>*/}
                {/*    <td><Field type="text" name="BankClock" value="60"*/}
                ...
                {/*    <td><Field type="text" name="BankReset" value="0"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Small blind:</td>*/}
                {/*    <td><Field type="text" name="SmallBlind" value="10"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Big blind:</td>*/}
                {/*    <td><Field type="text" name="BigBlind" value="20"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Small bet:</td>*/}
                {/*    <td><Field type="text" name="SmallBet" value="20"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Bring-in:</td>*/}
                {/*    <td><Field type="text" name="BringIn" value="0"*/}
                ...
                {/*    <td><Field type="text" name="RatholeMinutes" value="0"*/}
                ...
                {/*    <td><Field type="text" name="SitoutMinutes" value="10"*/}
                ...
                {/*<tr>*/}
                {/*    <td>Table graphic:</td>*/}
                {/*    <td><Field type="text" name="TableGraphic" value=""*/}
                ...
                {/*<tr>*/}
                {/*    <td>Note:</td>*/}
                {/*    <td><Field type="text" name="Note" value=""*/}
                {/*               title="This is an optional note field, not seen by the players. 500 characters maximum."/>*/}
                {/*    </td>*/}
                {/*</tr>*/}
                {/*<tr>*/}
                {/*    <td colSpan="2" height="60" align="center">*/}
                {/*        <Field type="button" value="Ok" onClick="send('RGSaveAdd')"/> &nbsp;*/}
                {/*        <Field type="button" value="Cancel" onClick="send('RGCancel')"/>*/}
                {/*    </td>*/}
                {/*</tr>*/}
                <button>dfdfdfdf</button>
...
let ContactForm = reduxForm({form: 'addtable'})(FormAddTable)
const onSubmit=(values)=>{
    const args = [values.GameID];
    addTableThunk(...args);
